...
module tb_top;
	...
	// Round-Robin Arbiter
    	always_ff @(posedge clk or negedge rst_n) begin
    		if (!rst_n) begin
        		selected_core <= 2'b00;
		//end else begin selected_core <= 2'b00;		// Arbiter Bug - Starvation
    		end else begin
	...
	initial begin
    		...
    		$display("| |                                                             | |");
    		$display("| |               ECE-593: PRE-SILICON VALIDATION               | |");
    		$display("| |             FINAL PROJECT: MULTIPROCESSOR SYSTEM            | |");
    		$display("| |_____________________________________________________________| |");
    		$display("|                                                                 |");
    		$display("|   +---------+     +---------+     +---------+     +---------+   |");
    		$display("|   |  CORE 0 |     |  CORE 1 |     |  CORE 2 |     |  CORE 3 |   |");
    		$display("|   +----+----+     +----+----+     +----+----+     +----+----+   |");
    		$display("|        |               |               |               |        |");
    		$display("|  ======+===============+===============+===============+======  |");
    		$display("|  ||              SHARED BUS & ARBITER LOGIC                 ||  |");
    		$display("|  =============================================================  |");
    		$display(" \\_______________________________________________________________/");
	end
