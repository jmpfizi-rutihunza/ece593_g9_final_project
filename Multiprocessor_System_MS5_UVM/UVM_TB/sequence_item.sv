...
class mp_transaction extends uvm_sequence_item;
	...
	constraint valid_op { opcode dist {
        			...
        			[4'b1011:4'b1101] := 15  // SPL_2/3/4 only; excludes illegal 1110,1111
    			}; }
	...
	function string convert2string();
  		return $sformatf("Core=%0d Op=0x%0h Addr=0x%03h A=0x%02h B=0x%02h Data=0x%02h Exp=0x%02h",
			 core_id, opcode, addr, A, B, data, expected_val);
	endfunction
